...
write_csv(yield_predictions_all_models, "data/yield_predictions_all_models.csv")
write_csv(model_performance_summary, "data/model_performance_summary.csv")
saveRDS(
  list(
    predictions = yield_predictions_all_models,
    metrics = model_performance_summary
  ),
  "data/yield_models_bundle.rds"
)